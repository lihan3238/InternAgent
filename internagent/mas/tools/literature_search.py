...
class LiteratureSearch:
    ...
    async def search_pubmed(self,
        ...
        logger.info(f"PubMed search disabled; returning empty result for query: {query}")
    ...
    async def search_semantic_scholar(self,
        ...
        logger.info(f"Semantic Scholar search disabled; returning empty result for query: {query}")
        self._cache[cache_key] = []
        return []
